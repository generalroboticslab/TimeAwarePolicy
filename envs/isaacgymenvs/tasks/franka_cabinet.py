...
class FrankaCabinet(VecTask):
    ...
    def compute_task_reward(self):
        ...
        violated_conditions = (
            ...
            | ~is_under_valid_vel(drawer_linvel_norm, self.MAX_VEL_NORM)
        )
    ...
    def reset_idx(self, env_ids):
        ...
        if len(new_cfg_env_ids) > 0:
            ...
            self._apply_knn_reference_targets(
                new_cfg_env_ids,
                {
                    "cabinet_base_pose": self.cab_base_state[new_cfg_env_ids, :7],
                    "cabinet_dof_pos": self.cab_init_dof[new_cfg_env_ids],
