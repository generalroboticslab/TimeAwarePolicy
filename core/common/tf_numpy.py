"""NumPy rigid-body transformation helpers.

The ``tf`` prefix means *transformation*, not TensorFlow. Functions cover
quaternion algebra, pose composition, rotation conversions, and filtering.
"""
